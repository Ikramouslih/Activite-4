...
public class HospitalAppApplication {
    ...
    @Bean
    //Annotation Spring : utiliser avec les fonctions qu'on veut executer lors du démarrage
    CommandLineRunner start(PatientRepository patientRepository){
        //La fonction CommandLineRunner start : la première qui s'execute parmis tous les autres beans
        return args -> {
    ...
    PasswordEncoder passwordEncoder(){
        //methode de cryptage des mots de passe
